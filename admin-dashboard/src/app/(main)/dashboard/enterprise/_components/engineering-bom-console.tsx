    ...
    <Card className={dashCardClass}>
      <CardHeader className={dashCardHeaderClass}>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            className="border border-cyan-400/30 bg-cyan-500/10 text-cyan-100 hover:bg-cyan-400/15 hover:text-white"
      ...
      <CardContent className={dashCardContentClass}>
        <div className="flex h-48 flex-col justify-end overflow-y-auto rounded-lg border border-[#22314a] bg-[#0b1626]/90 p-4 font-mono text-xs shadow-inner">
          {logs.length === 0 ? (
        ...
        <div className="mt-3 rounded-lg border border-[#22314a] bg-[#0b1626]/90 p-3 font-mono text-slate-400 text-xs leading-relaxed">
          <div className="mb-2">
