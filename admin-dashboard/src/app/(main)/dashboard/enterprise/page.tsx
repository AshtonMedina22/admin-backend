...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col gap-3 md:gap-4">
      <div className="flex flex-col gap-1 border-[#22314a] border-b pb-3">
      ...
      <Tabs defaultValue="telemetry" className="flex flex-col gap-4">
        <TabsList className="h-auto w-full max-w-xl justify-start gap-1 overflow-x-auto rounded-xl border border-[#22314a] bg-[#0f1b2d]/90 p-1 shadow-[0_12px_35px_rgba(2,8,23,0.35)] md:w-fit">
