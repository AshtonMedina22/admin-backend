...
export function TelemetrySimulatorControl({ isSimulating, onSimulatingChange, liveYield }: TelemetrySimulatorProps) {
  return (
    <div className="grid gap-3 rounded-xl border border-zinc-800 bg-zinc-900/60 p-4 backdrop-blur-md">
      ...
      <div className="rounded-lg border border-zinc-900 bg-zinc-950 p-3 font-mono text-cyan-400/90 text-xs leading-relaxed">
