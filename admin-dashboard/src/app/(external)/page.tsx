    ...
    <div className="flex min-h-dvh flex-col items-center justify-center bg-background px-4 py-16">
      <div className="mx-auto flex max-w-lg flex-col items-center text-center">
        ...
        <h1 className="font-semibold text-2xl tracking-tight sm:text-3xl">
          {DEMO_ORG.parent} &bull; Core Systems Management
        </h1>
        <p className="mt-4 text-muted-foreground text-sm leading-relaxed sm:text-base">
          Authorized Personnel Only. Cross-entity directory authentication required for {DEMO_ORG.retail},{" "}
          {DEMO_ORG.commercial}, and {DEMO_ORG.portfolio} telemetry access.
        </p>
