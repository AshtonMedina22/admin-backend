    ...
    <Card className={dashCardClass}>
      <CardContent className="grid gap-2 p-5 md:p-6">
        <div className="flex flex-wrap items-center gap-2">
          <span className="rounded-full border border-[#2a2a2d] bg-[#101113] px-2.5 py-1 font-mono text-[11px] text-slate-400 uppercase tracking-[0.18em]">
            Task Management
          </span>
    ...
    <div className="mb-2 grid grid-cols-1 gap-5 lg:grid-cols-2">
      ...
      <Card className={dashCardClass}>
        ...
        <CardContent className={cn("grid gap-4", dashSectionCardContentClass)}>
          ...
          <Button className="w-full rounded-md border border-cyan-400/30 bg-white/5 px-3 py-2 font-mono text-cyan-100 text-xs transition-all hover:bg-white/10 hover:text-white active:scale-[0.98]">
