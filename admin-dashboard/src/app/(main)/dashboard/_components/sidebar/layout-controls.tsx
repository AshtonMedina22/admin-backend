  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
          size="icon"
          className="border border-[#22314a] bg-[#0b1626]/80 text-slate-300 hover:bg-cyan-500/10 hover:text-cyan-100"
        >
          <Settings />
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end" className="border-[#22314a] bg-[#0b1626] text-slate-100 shadow-2xl">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            <h4 className="font-medium text-sm leading-none">Preferences</h4>
            <p className="text-slate-400 text-xs">Customize your dashboard layout preferences.</p>
          </div>
