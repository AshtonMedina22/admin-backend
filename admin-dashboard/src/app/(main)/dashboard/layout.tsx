      ...
      >
        ...
        <SidebarInset
          className={cn(
            ...
            "dashboard-shell min-w-0 overflow-x-hidden bg-[#07111f] text-slate-100",
          )}
        >
          <header
            className={cn(
              "flex h-12 shrink-0 items-center gap-2 border-[#22314a] border-b bg-[#07111f]/95 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12",
              "[html[data-navbar-style=sticky]_&]:sticky [html[data-navbar-style=sticky]_&]:top-0 [html[data-navbar-style=sticky]_&]:z-50 [html[data-navbar-style=sticky]_&]:overflow-hidden [html[data-navbar-style=sticky]_&]:rounded-t-[inherit] [html[data-navbar-style=sticky]_&]:bg-[#07111f]/85 [html[data-navbar-style=sticky]_&]:backdrop-blur-md",
            )}
          >
          ...
          <div className="min-h-0 min-w-0 flex-1 overflow-x-hidden bg-[#07111f] p-3 has-data-[content-padding=false]:p-0 md:p-5">
