      ...
      {domainMonitors.map((domain) => (
        ...
        >
          ...
          <CardContent className={cn("grid gap-2 text-sm", dashCardContentClass)}>
            <div className="flex flex-wrap items-center justify-between gap-2 rounded-md border border-[#dbe5ee] bg-[#ffffff]/80 px-3 py-2">
  ...
  return (
    <Card className={dashCardClass}>
      ...
      <CardContent className={cn("grid gap-4", dashCardContentClass)}>
        <div className="scrollbar-none block w-full overflow-x-auto rounded-md border border-[#dbe5ee]">
        ...
        <div className="rounded-md border border-[#dbe5ee] bg-[#ffffff]/80 p-4 font-medium font-mono text-slate-300">
