...
export const dashInfoBannerClass =
  "rounded-lg border border-[color-mix(in_oklab,var(--brand-3sk)_30%,transparent)] border-l-4 border-l-[var(--brand-3sk)] bg-[var(--brand-3sk-bg)] px-4 py-3 text-[var(--brand-3sk-text)]";
