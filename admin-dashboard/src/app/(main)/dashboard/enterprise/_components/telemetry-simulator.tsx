...
export function TelemetrySimulatorControl({ isSimulating, onSimulatingChange, liveYield }: TelemetrySimulatorProps) {
  return (
    <div className="grid gap-3 rounded-xl border border-[#2a2a2d] bg-[#141416]/90 p-4 shadow-[0_12px_35px_rgba(2,8,23,0.28)] backdrop-blur-md">
        ...
        <span
          className={cn(
            ...
            isSimulating
              ...
              : "border-[#2a2a2d] bg-[#101113] text-slate-500",
          )}
        >
          <span
      ...
      <div className="rounded-lg border border-[#2a2a2d] bg-[#101113]/90 p-3 font-mono text-cyan-300 text-xs leading-relaxed">
