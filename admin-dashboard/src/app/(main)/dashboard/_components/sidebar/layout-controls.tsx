  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button
          size="icon"
          className="border border-[#2a2a2d] bg-[#101113]/80 text-slate-300 hover:bg-white/5 hover:text-cyan-100"
        >
          <Settings />
        </Button>
      </PopoverTrigger>
      <PopoverContent align="end" className="border-[#2a2a2d] bg-[#101113] text-slate-100 shadow-2xl">
