      ...
      <Card className="border-amber-500/40 bg-amber-500/5">
        <CardContent className="flex items-start gap-3 pt-6">
          ...
          <p className="text-amber-950 text-sm leading-relaxed dark:text-amber-200">
            Critical Path Blockage: Solar 3SK Frisco Commercial Plaza cannot transition to structural assembly until
            North Texas Structural PE Group uploads verified load assessment blueprints. North TX Racking Crews general
              ...
              <TableBody>
                {filteredVendors.map((vendor) => (
                  <TableRow key={vendor.id}>
                    <TableCell className="py-2 font-medium">{vendor.name}</TableCell>
                    <TableCell className="py-2">{vendor.specialtyType}</TableCell>
