      ...
      >
        ...
        <SidebarInset
          className={cn(
            ...
            "min-w-0 overflow-x-hidden bg-zinc-950 text-zinc-100",
          )}
        >
          <header
            className={cn(
              "flex h-12 shrink-0 items-center gap-2 border-zinc-900 border-b bg-zinc-950/95 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12",
              "[html[data-navbar-style=sticky]_&]:sticky [html[data-navbar-style=sticky]_&]:top-0 [html[data-navbar-style=sticky]_&]:z-50 [html[data-navbar-style=sticky]_&]:overflow-hidden [html[data-navbar-style=sticky]_&]:rounded-t-[inherit] [html[data-navbar-style=sticky]_&]:bg-zinc-950/80 [html[data-navbar-style=sticky]_&]:backdrop-blur-md",
            )}
          >
          ...
          <div className="min-h-0 min-w-0 flex-1 overflow-x-hidden bg-zinc-950 p-3 has-data-[content-padding=false]:p-0 md:p-4">
