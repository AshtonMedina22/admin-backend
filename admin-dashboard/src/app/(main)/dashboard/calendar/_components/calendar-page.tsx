    ...
    <div className="mb-2 grid grid-cols-1 gap-5 lg:grid-cols-2">
      ...
      <Card className={dashCardClass}>
        ...
        <CardContent className={cn("grid gap-4", dashSectionCardContentClass)}>
          ...
          <Button className="w-full rounded-md border border-cyan-400/30 bg-sky-50 px-3 py-2 font-mono text-cyan-100 text-xs transition-all hover:bg-sky-100 hover:text-white active:scale-[0.98]">
