  ...
  return (
    <>
      ...
      >
        ...
        Search
        <kbd className="inline-flex h-5 select-none items-center gap-1 rounded border border-[#22314a] bg-[#0b1626] px-1.5 font-medium text-[10px] text-slate-300">
      ...
      <CommandDialog
        ...
        className="border border-[#22314a] bg-[#0b1626] text-slate-100 shadow-2xl"
      >
        <Command className="border border-[#22314a] bg-[#0b1626] text-slate-100">
