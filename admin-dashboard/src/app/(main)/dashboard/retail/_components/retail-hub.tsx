  ...
  return (
    <div className={dashPageClass}>
      ...
      <Tabs defaultValue="orders" className="flex flex-col gap-4">
        <TabsList className="h-auto w-full justify-start gap-1 overflow-x-auto rounded-xl border border-[#22314a] bg-[#0f1b2d]/90 p-1 shadow-[0_12px_35px_rgba(2,8,23,0.35)] md:w-fit">
          <TabsTrigger
            value="orders"
            className="gap-2 border border-transparent px-3 py-2 text-slate-400 transition-all hover:border-lime-400/20 hover:bg-[#16253b] hover:text-slate-100 data-[state=active]:border-lime-400/40 data-[state=active]:bg-[#1a2b44] data-[state=active]:font-semibold data-[state=active]:text-lime-100"
          >
