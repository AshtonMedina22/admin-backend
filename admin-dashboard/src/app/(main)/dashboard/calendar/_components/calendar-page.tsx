    ...
    <Card className={dashCardClass}>
      <CardContent className="grid gap-2 p-5 md:p-6">
        <div className="flex flex-wrap items-center gap-2">
          <span className="rounded-full border border-[#dbe5ee] bg-[#ffffff] px-2.5 py-1 font-mono text-[11px] text-slate-400 uppercase tracking-[0.18em]">
            Task Management
          </span>
        ...
        <h1 className="text-balance font-bold text-2xl text-slate-950 tracking-tight md:text-3xl">Tasks & Schedule</h1>
