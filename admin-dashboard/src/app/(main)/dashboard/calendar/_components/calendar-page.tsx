    ...
    <Card className={dashCardClass}>
      <CardContent className="grid gap-2 p-5 md:p-6">
        <div className="flex flex-wrap items-center gap-2">
          <span className="rounded-full border border-[#1B1B3A]/10 bg-[#FFFFFF] px-2.5 py-1 font-mono text-[#1B1B3A]/60 text-[11px] uppercase tracking-[0.18em]">
            Task Management
          </span>
        ...
        <h1 className="text-balance font-bold text-2xl text-[#1B1B3A] tracking-tight md:text-3xl">Tasks & Schedule</h1>
        <p className="max-w-3xl text-[#1B1B3A]/60 text-sm leading-relaxed">
    ...
    <div className="mb-2 grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <CardContent className={cn("grid gap-3", dashSectionCardContentClass)}>
          {actionItems.map((item) => (
            <div
              key={item.text}
              className={cn(
                "rounded-lg border border-[#1B1B3A]/10 border-l-2 bg-[#1B1B3A]/60 p-3",
      ...
      <Card className={dashCardClass}>
        ...
        <CardContent className={cn("grid gap-4", dashSectionCardContentClass)}>
          <div className="rounded-lg border border-[#1B1B3A]/10 bg-[#1B1B3A]/60 p-4">
            ...
            <p className="mt-2 font-mono text-[#1B1B3A]/60 text-xs leading-relaxed">
            ...
            <div className="mt-2 border-zinc-950 border-t pt-2 font-mono text-[#1B1B3A]/60 text-xs leading-relaxed">
          ...
          <Button className="w-full rounded-md border border-cyan-400/30 bg-sky-50 px-3 py-2 font-mono text-sky-700 text-xs transition-all hover:bg-sky-100 hover:text-sky-800 active:scale-[0.98]">
    ...
    <Card className={cn("border-cyan-500/60 border-l-4", dashCardClass)}>
      ...
      <CardContent className={cn("grid gap-4 lg:grid-cols-[0.85fr_1.25fr]", dashSectionCardContentClass)}>
        <div className="space-y-3">
          <div className="rounded-lg border border-[#1B1B3A]/10 bg-[#F7F7FF] p-3">
            <p className="font-mono text-[11px] text-cyan-300 uppercase tracking-[0.18em]">Scheduling contract</p>
            <ol className="mt-3 space-y-2 text-[#1B1B3A]/60 text-xs leading-relaxed">
          ...
          <div className="rounded-lg border border-amber-500/20 bg-amber-950/20 p-3 font-mono text-[#1B1B3A]/60 text-xs leading-relaxed">
        ...
        <div className="grid gap-3">
          <pre className="max-h-80 overflow-auto rounded-lg border border-[#1B1B3A]/10 bg-[#1B1B3A] p-4 font-mono text-[10px] text-cyan-200 leading-relaxed">
            <code>{GOOGLE_CALENDAR_SYNC_SCRIPT}</code>
          </pre>
          <pre className="max-h-52 overflow-auto rounded-lg border border-[#1B1B3A]/10 bg-[#1B1B3A] p-4 font-mono text-[10px] text-amber-200 leading-relaxed">
...
function AgendaFeed({ events }: { events: Array<CalendarEvent & { day: number }> }) {
  return (
    <Card size="sm" className={cn("border-indigo-500/70 border-l-4 bg-[#FFFFFF]", dashCardClass)}>
