      ...
      {showPlatformConfig ? (
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <pre className="overflow-x-auto rounded-md border bg-muted/40 p-3 font-mono text-[11px] text-muted-foreground leading-relaxed">
              Active Data Path Mapping via lib/google-sheets.ts: [slug] -&gt; SLUG_SHEET_NAMES Dictionary Validation
              Pass
            </pre>
          </CardContent>
        </Card>
