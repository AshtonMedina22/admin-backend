...
const workbook: Record<string, SheetSpec> = {
  Dashboard: {
    ...
    values: [
      ...
      [
        "Active B2B Pipeline",
        "$680,000",
        "Solar 3SK active contract and proposal pipeline value.",
        "Solar 3SK",
        "Healthy",
      ],
      [
        "Live Fleet Yield",
        "48.2 kW",
        "Real-time grid performance across active managed arrays.",
        "Yellow Star Power",
        "Healthy",
      ],
      [
  ...
  "Contractors & Vendors": {
    ...
    values: [
      ...
      [
        "Rich Solar Distribution",
        "Hardware Wholesaler",
        "Bulk 3KW Inverter Pallet Freight",
        "Solar 2SK",
        "In Transit via LTL",
        "$14,250",
        "North Texas",
      ...
      [
        ...
        "120kW Roof Load Assessment",
        "Solar 3SK",
        "Awaiting PE Signature",
        "$3,200",
        "DFW Metro",
        "1",
        "Verified Active",
      ...
      [
        "Lone Star Electrical & Interconnection",
        "Field Subcontractor",
        "Hunt County Combiner Box Upgrade",
        "Yellow Star Power",
        "On-Site Crew Dispatched",
        "$8,500",
        "Hunt County",
        "1",
        "Verified Active",
      ...
      [
        "DFW Solar Appointment Setters",
        "Marketing Agency / Lead Gen",
        "Commercial Roof Pre-Qualification Run",
        "Solar 3SK",
        "Completed Pay-Per-Sit Out",
        "$1,800",
        "DFW Metro",
        "0",
        "Verified Active",
  ...
  Calendar: {
    ...
    values: [
      ...
      [
        "2026-06-15",
        "Solar 3SK",
        "Submit zoning variance paperwork to City of Plano Building Inspections Department for 60kW Auto Body build.",
        "Alex Morgan",
      ],
      [
        "2026-06-18",
        "Solar 2SK",
        "Inbound bulk freight pallet arrival from Rich Solar at Wylie Warehouse.",
        "Jordan Lee",
      ],
      [
        "2026-06-22",
        "Yellow Star Power",
        "Oncor on-site utility engineering field inspection window for Hunt County 60kW asset expansion tie-in.",
        "Alex Morgan",
      ],
      [
        "2026-06-26",
        "Solar 3SK",
        "Structural engineer on-site roof load assessment walk at Frisco Commercial Plaza.",
        "North Texas Structural PE Group",
      ],
    ],
  },
