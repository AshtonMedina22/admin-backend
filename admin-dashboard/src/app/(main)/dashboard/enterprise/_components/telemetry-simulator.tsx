...
export function TelemetrySimulatorControl({ isSimulating, onSimulatingChange, liveYield }: TelemetrySimulatorProps) {
  return (
    <div className="grid gap-3 rounded-xl border border-[#dbe5ee] bg-[#ffffff]/90 p-4 shadow-[0_12px_35px_rgba(2,8,23,0.28)] backdrop-blur-md">
        ...
        <span
          className={cn(
            ...
            isSimulating
              ...
              : "border-[#dbe5ee] bg-[#ffffff] text-slate-500",
          )}
        >
          <span
      ...
      <div className="rounded-lg border border-[#dbe5ee] bg-[#ffffff]/90 p-3 font-mono text-cyan-300 text-xs leading-relaxed">
